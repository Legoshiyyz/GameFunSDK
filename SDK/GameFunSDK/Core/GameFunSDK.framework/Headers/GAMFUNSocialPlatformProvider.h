//
//  GAMFUNSocialPlatformProvider.h
//  GameFunSDK
//
...
@protocol GAMFUNSocialPlatformProvider <NSObject>
...
-(void)toirdateoSocial_AuthorizeWithUserInfo:(NSDictionary *)userInfo
                withCompletionHandler:(GAMFUNSocialPlateLoginCompletionHandler)completionHandler;
 ...
 *  @discuss userInfo        In some platforms it can be brought in, if not it passes into nil.
 */
-(void)toirdateoSocial_cancelAuthWithCompletionHandler:(GAMFUNSocialPlateLogoutCompletionHandler)completionHandler;


/**
 *  Setting share platform
 *
 *  @param messageObject  share content @see GAMFUNMessageObject
 *  @param completion     callback
 */
- (void)toirdateoSocial_shareMessageObject:(GAMFUNSocialMessageObject *)messageObject
                           completion:(GAMFUNShareCompleteHandler)completion;
 ...
 *
 *  @param messageObject  message content @see GAMFUNMessageObject
 *  @param completion     callback
 *
*/
- (void)toirdateoSocial_showFBFriendsSendInvitations:(GAMFUNSocialMessageObject *)messageObject
                                     completion:(GAMFUNShareCompleteHandler)completion;
